#!/usr/bin/env bash
# Single-reversal ACE plasticity-switch experiment — 1 000 trials per phase.
...
# 1 000 trials per phase, pre-generated task pkl.
...
python3 experiment_scripts/run_context_signal_abef_plasticity_switch_multirun.py \
    ...
    --plot_stims        0,2,4 \
    --results_dir       results/21_04_26_singlerev_ace_plasticity_1000tpp
